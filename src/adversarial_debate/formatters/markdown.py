...
class MarkdownFormatter(Formatter):
    ...
    def _md_header(self, metadata: dict[str, Any]) -> str:
        ...
        return f"""# 🛡️ Security Analysis Report
...
> {timestamp}"""
    ...
    def _md_verdict(self, verdict: dict[str, Any]) -> str:
        ...
        emoji = VERDICT_EMOJI.get(decision, "❓")
...
*Report generated by [{self.config.tool_name}](https://github.com/dr-gareth-roberts/adversarial-debate) v{self.config.tool_version}*
"""
