...
class TestChaosOrchestratorAgentContext:
    ...
    def test_context_creation_basic(self, base_context):
        ...
        context = ChaosOrchestrator.create_agent_context_for_attack(
            attack, base_context, code
        )
    ...
    def test_context_empty_vectors(self, base_context):
        ...
        assert "success_indicators" not in context.inputs or context.inputs["success_indicators"] == []
