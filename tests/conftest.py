...
from adversarial_debate.config import Config, ProviderConfig, LoggingConfig, SandboxConfig
from adversarial_debate.providers import LLMProvider, LLMResponse, Message
from adversarial_debate.store import BeadStore, Bead, BeadType, Artefact
...
def test_config() -> Config:
    ...
    return Config(
        ...
        sandbox=SandboxConfig(
            enabled=False,  # Disable sandbox for tests
            timeout_seconds=5,
        ),
        debug=True,
        dry_run=False,
