...
5. **Repo hygiene / secret scanning**
   - Removed tracked `.bevel/do_not_share/*` artifacts.
...
- **Sandbox behavior in containers**
...
- **Docs deep pass**
  - Updated `docs/architecture.md` and `docs/pipeline.md` to match current CLI behavior and output paths.
- **Import-cycle guard**
